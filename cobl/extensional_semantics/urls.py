...
from cobl.extensional_semantics.views import add_lexeme_extension_citation, \
                                              add_relation, \
                                              add_semantic_domain, \
...
from cobl.urls import R

# TODO move these views to:
# from cobl.extensional_semantics.views import *
...
urlpatterns = patterns(
    ...
    url(r'^domains/add-new/$', add_semantic_domain,
        name="add-semantic-domain"),
    ...
    url(r'^lexeme/%(LEXEME_ID)s/domain/%(DOMAIN)s/edit/$' % R,
        lexeme_domain_view, {"action": "edit"},
        name="edit-lexeme-extensions"),

    # Semantic extensions of lexemes -- individual extensions
    url((r'^domain/%(DOMAIN)s/extension/'
         '(?P<extension_id>\d+)/add-citation/$') % R,
