...
from cobl.views import add_language_list, \
                        add_meaning_list, \
                        changeDefaults, \
                        cognate_report, \
                        delete_language, \
...
from cobl.lexicon.views import CognateClassCitationCreateView, \
                                cognate_class_citation_delete, \
                                CognateClassCitationUpdateView, \
                                DumpRawDataView, \
                                NexusExportView
from cobl.lexicon.models import CognateClassCitation, \
                                 CognateJudgement, \
                                 CognateJudgementCitation, \
                                 LanguageList, \
                                 LexemeCitation, \
                                 MeaningList
from cobl.profiles.views import view_profile, alter_profile, change_password
...
if settings.semantic_domains:
    urlpatterns += [('', include('cobl.extensional_semantics.urls'))]
