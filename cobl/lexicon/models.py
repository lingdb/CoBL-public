...
from cobl.utilities import two_by_two, compressedField
from cobl.lexicon.validators import suitable_for_url, standard_reserved_names
...
# add_introspection_rules([], ["^cobl\.lexicon\.models\.CharNullField"])
...
class CognateClass(AbstractTimestamped):
    ...
    lateParallelDerivationWithCognate = models.ForeignKey(
        "self", null=True, related_name='+')
    supersetid = models.TextField(blank=True)
    ...
    def timestampedFields(self):
        return set(['alias', 'notes', 'justificationDiscussion', 'root_form', 'root_language',
                    ...
                    'lateParallelDerivationWithCognate', 'supersetid'])
...
class LanguageList(models.Model):
    ...
    table (cf. cobl.models.update_language_list_all)
