...
from cobl.lexicon.models import Clade, Language, LanguageClade


def mkUpdateLanguageCladeRelations(Language, Clade, LanguageClade):
    '''
    Factory function for updateLanguageCladeRelations
    so that it can be used in migrations by providing different models.
    '''
    ...
    def updateLanguageCladeRelations(languages=None, clades=None):
        ...
        Iff clades or languages are None they will be fetched from the db.
