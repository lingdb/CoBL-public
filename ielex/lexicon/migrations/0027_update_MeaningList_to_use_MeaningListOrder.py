...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeaningList.meaning_ids'
        db.delete_column('lexicon_meaninglist', 'meaning_ids')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MeaningList.meaning_ids'
        raise RuntimeError("Cannot reverse this migration. 'MeaningList.meaning_ids' and its values cannot be restored.")
    ...
    models = {
        ...
        'lexicon.meaninglist': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meanings': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lexicon.Meaning']", 'through': "orm['lexicon.MeaningListOrder']", 'symmetrical': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
