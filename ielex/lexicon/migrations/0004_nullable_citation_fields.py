...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LexemeCitation.comment'
        db.alter_column('lexicon_lexemecitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

        # Changing field 'LexemeCitation.pages'
        db.alter_column('lexicon_lexemecitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

        # Changing field 'CognateClassCitation.comment'
        db.alter_column('lexicon_cognateclasscitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

        # Changing field 'CognateClassCitation.pages'
        db.alter_column('lexicon_cognateclasscitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

        # Changing field 'CognateJudgementCitation.comment'
        db.alter_column('lexicon_cognatejudgementcitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

        # Changing field 'CognateJudgementCitation.pages'
        db.alter_column('lexicon_cognatejudgementcitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999, null=True))

    def backwards(self, orm):
        
        # Changing field 'LexemeCitation.comment'
        db.alter_column('lexicon_lexemecitation', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=999))

        # Changing field 'LexemeCitation.pages'
        db.alter_column('lexicon_lexemecitation', 'pages', self.gf('django.db.models.fields.CharField')(default='', max_length=999))

        # Changing field 'CognateClassCitation.comment'
        db.alter_column('lexicon_cognateclasscitation', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=999))

        # Changing field 'CognateClassCitation.pages'
        db.alter_column('lexicon_cognateclasscitation', 'pages', self.gf('django.db.models.fields.CharField')(default='', max_length=999))

        # Changing field 'CognateJudgementCitation.comment'
        db.alter_column('lexicon_cognatejudgementcitation', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=999))

        # Changing field 'CognateJudgementCitation.pages'
        db.alter_column('lexicon_cognatejudgementcitation', 'pages', self.gf('django.db.models.fields.CharField')(default='', max_length=999))
    ...
    models = {
        ...
        'lexicon.cognateclasscitation': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '999', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'pages': ('django.db.models.fields.CharField', [], {'max_length': '999', 'null': 'True'}),
