...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CognateClass.name'
        db.add_column('lexicon_cognateclass', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'CognateClass.name'
        db.delete_column('lexicon_cognateclass', 'name')
