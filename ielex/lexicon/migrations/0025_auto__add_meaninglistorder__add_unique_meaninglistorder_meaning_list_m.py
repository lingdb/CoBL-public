...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeaningListOrder'
        db.create_table('lexicon_meaninglistorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meaning', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lexicon.Meaning'])),
            ('meaning_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lexicon.MeaningList'])),
            ('order', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('lexicon', ['MeaningListOrder'])

        # Adding unique constraint on 'MeaningListOrder', fields ['meaning_list', 'meaning']
        db.create_unique('lexicon_meaninglistorder', ['meaning_list_id', 'meaning_id'])

        # Adding unique constraint on 'MeaningListOrder', fields ['meaning_list', 'order']
        db.create_unique('lexicon_meaninglistorder', ['meaning_list_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'MeaningListOrder', fields ['meaning_list', 'order']
        db.delete_unique('lexicon_meaninglistorder', ['meaning_list_id', 'order'])

        # Removing unique constraint on 'MeaningListOrder', fields ['meaning_list', 'meaning']
        db.delete_unique('lexicon_meaninglistorder', ['meaning_list_id', 'meaning_id'])

        # Deleting model 'MeaningListOrder'
        db.delete_table('lexicon_meaninglistorder')
    ...
    models = {
        ...
        'lexicon.meaninglistorder': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('meaning_list', 'meaning'), ('meaning_list', 'order'))", 'object_name': 'MeaningListOrder'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meaning': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lexicon.Meaning']"}),
            'meaning_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lexicon.MeaningList']"}),
            'order': ('django.db.models.fields.FloatField', [], {})
        },
        'lexicon.source': {
