...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LanguageList', fields ['name']
        db.create_unique('lexicon_languagelist', ['name'])

    def backwards(self, orm):
        # Removing unique constraint on 'LanguageList', fields ['name']
        db.delete_unique('lexicon_languagelist', ['name'])
