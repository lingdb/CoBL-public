...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lexicon_cognateclass', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):
        
        # Changing field 'CognateClass.name'
        db.alter_column('lexicon_cognateclass', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
