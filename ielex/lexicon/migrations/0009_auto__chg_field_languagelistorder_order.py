...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LanguageListOrder.order'
        db.alter_column('lexicon_languagelistorder', 'order', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'LanguageListOrder.order'
        db.alter_column('lexicon_languagelistorder', 'order', self.gf('django.db.models.fields.IntegerField')())
