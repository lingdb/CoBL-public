...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lexeme.number_cognate_coded'
        db.add_column('lexicon_lexeme', 'number_cognate_coded', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lexeme.number_cognate_coded'
        db.delete_column('lexicon_lexeme', 'number_cognate_coded')
