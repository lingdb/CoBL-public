...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lexicon_cognateclasscitation', 'comment', self.gf('django.db.models.fields.TextField')())
        ...
        db.alter_column('lexicon_cognatejudgementcitation', 'comment', self.gf('django.db.models.fields.TextField')())
        ...
        db.alter_column('lexicon_lexemecitation', 'comment', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CognateClassCitation.comment'
        db.alter_column('lexicon_cognateclasscitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999))

        # Changing field 'CognateClassCitation.pages'
        db.alter_column('lexicon_cognateclasscitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999))

        # Changing field 'CognateJudgementCitation.comment'
        db.alter_column('lexicon_cognatejudgementcitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999))

        # Changing field 'CognateJudgementCitation.pages'
        db.alter_column('lexicon_cognatejudgementcitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999))

        # Changing field 'LexemeCitation.comment'
        db.alter_column('lexicon_lexemecitation', 'comment', self.gf('django.db.models.fields.CharField')(max_length=999))

        # Changing field 'LexemeCitation.pages'
        db.alter_column('lexicon_lexemecitation', 'pages', self.gf('django.db.models.fields.CharField')(max_length=999))
