...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meaning.percent_coded'
        db.add_column('lexicon_meaning', 'percent_coded', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Meaning.percent_coded'
        db.delete_column('lexicon_meaning', 'percent_coded')
