    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', ielex.lexicon.models.CharNullField(blank=True, max_length=128, unique=True, null=True, validators=[ielex.lexicon.validators.suitable_for_url])),
            ],
            options={
                'ordering': ['alias'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('cognate_class', models.ForeignKey(to='lexicon.CognateClass')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('cognate_judgement', models.ForeignKey(to='lexicon.CognateJudgement')),
            ],
        ),
        migrations.CreateModel(
            name='DyenCognateSet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ascii_name', models.CharField(unique=True, max_length=128, validators=[ielex.lexicon.validators.suitable_for_url])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=128, validators=[ielex.lexicon.validators.suitable_for_url, ielex.lexicon.validators.standard_reserved_names])),
                ('description', models.TextField(null=True, blank=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_list', models.ForeignKey(to='lexicon.LanguageList')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('number_cognate_coded', models.IntegerField(default=0, editable=False)),
                ('denormalized_cognate_classes', models.TextField(editable=False, blank=True)),
                ('cognate_class', models.ManyToManyField(to='lexicon.CognateClass', through='lexicon.CognateJudgement', blank=True)),
                ('language', models.ForeignKey(to='lexicon.Language')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('gloss', models.CharField(max_length=64, validators=[ielex.lexicon.validators.suitable_for_url])),
                ('description', models.CharField(max_length=64, blank=True)),
                ('notes', models.TextField(blank=True)),
                ('percent_coded', models.FloatField(default=0, editable=False)),
            ],
            options={
                'ordering': ['gloss'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_code', models.CharField(default=b'P', max_length=1, choices=[(b'P', b'Publication'), (b'U', b'URL'), (b'E', b'Expert')])),
        ...
        migrations.AddField(
            ...
            name='meanings',
            field=models.ManyToManyField(to='lexicon.Meaning', through='lexicon.MeaningListOrder'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='lexeme',
            name='meaning',
            field=models.ForeignKey(blank=True, to='lexicon.Meaning', null=True),
        ),
        migrations.AddField(
            model_name='lexeme',
            name='source',
            field=models.ManyToManyField(to='lexicon.Source', through='lexicon.LexemeCitation', blank=True),
        ),
        migrations.AddField(
            model_name='languagelist',
            name='languages',
            field=models.ManyToManyField(to='lexicon.Language', through='lexicon.LanguageListOrder'),
        ),
        migrations.AddField(
            model_name='dyenname',
            name='language',
        ...
        migrations.AddField(
            model_name='cognatejudgement',
            name='source',
            field=models.ManyToManyField(to='lexicon.Source', through='lexicon.CognateJudgementCitation'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='meaninglistorder',
            unique_together=set([('meaning_list', 'order'), ('meaning_list', 'meaning')]),
        ),
        migrations.AlterUniqueTogether(
            name='lexemecitation',
        ...
        migrations.AlterUniqueTogether(
            name='languagelistorder',
            unique_together=set([('language_list', 'language'), ('language_list', 'order')]),
        ),
        migrations.AlterUniqueTogether(
            name='cognatejudgementcitation',
