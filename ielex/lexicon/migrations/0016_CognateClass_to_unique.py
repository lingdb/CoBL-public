...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CognateClass', fields ['name']
        db.create_unique('lexicon_cognateclass', ['name'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'CognateClass', fields ['name']
        db.delete_unique('lexicon_cognateclass', ['name'])
