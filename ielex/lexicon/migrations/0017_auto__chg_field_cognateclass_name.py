...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CognateClass.name'
        db.alter_column('lexicon_cognateclass', 'name', self.gf('ielex.lexicon.models.CharNullField')(max_length=128, unique=True, null=True))
    def backwards(self, orm):

        # Changing field 'CognateClass.name'
        db.alter_column('lexicon_cognateclass', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True))
    models = {
