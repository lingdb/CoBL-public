...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LanguageList.language_ids'
        db.delete_column('lexicon_languagelist', 'language_ids')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LanguageList.language_ids'
        raise RuntimeError("Cannot reverse this migration. 'LanguageList.language_ids' and its values cannot be restored.")
