...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lexeme.denormalized_cognate_classes'
        db.add_column('lexicon_lexeme', 'denormalized_cognate_classes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Lexeme.denormalized_cognate_classes'
        db.delete_column('lexicon_lexeme', 'denormalized_cognate_classes')
