...
urlpatterns = patterns('',
    ...
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>edit)/$' % R,
            lexeme_edit, name="edit-lexeme"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>add-cognate|add-new-citation)/$' % R,
            lexeme_edit),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>add-citation)/(?P<citation_id>\d+)/$' % R,
            lexeme_edit, name="lexeme-add-citation"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>edit-citation)/(?P<citation_id>\d+)/$' % R,
            lexeme_edit, name="lexeme-edit-citation"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>delink-citation)/(?P<citation_id>\d+)/$' % R,
            lexeme_edit, name="lexeme-delink-citation"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>delink-cognate)/%(COGJUDGE_ID)s/$' % R,
            lexeme_edit, name="lexeme-delink-cognate"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>edit-cognate-citation)/(?P<citation_id>\d+)/$' % R,
            lexeme_edit, name="lexeme-edit-cognate-citation"), # just use <cogjudge_id>
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>delink-cognate-citation)/(?P<citation_id>\d+)/$' % R,
            lexeme_edit, name="lexeme-delink-cognate-citation"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>add-cognate-citation)/%(COGJUDGE_ID)s/$' % R,
            lexeme_edit, name="lexeme-add-cognate-citation"),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>add-new-cognate-citation)/%(COGJUDGE_ID)s/$' % R,
            lexeme_edit),
    url(r'^lexeme/%(LEXEME_ID)s/(?P<action>add-new-cognate)/$' % R,
            lexeme_edit, name="lexeme-add-new-cognate"),
    ...
    url(r'^source/(?P<source_id>\d+)/(?P<action>edit)/$', source_edit,
            name="edit-source"),
    url(r'^source/(?P<source_id>\d+)/(?P<action>delete)/$', source_edit,
            name="delete-source"),
    url(r'^source/(?P<action>add)/$', source_edit),
    url(r'^source/(?P<action>add)/cognate-judgement/%(COGJUDGE_ID)s/$' % R,
            source_edit, name="cogjudge-add-new-source"),
